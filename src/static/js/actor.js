            ...
            if (mediaType === "movie") {
                ...
                fetch("/getSerieData/" + movieId).then(function(response) {
                    ...
                    for (let season of serieSeasons) {
                        ...
                        let seasonDescription = season.seasonDescription
                        let seasonName = season.seasonName
                        let seasonEpisodesNumber = season.episodesNumber
                        let seasonNumber = season.seasonNumber
                        let seasonUrl = "/serie/" + serieTitle + "/" + seasonNumber
                        let seasonRelease = season.release
...
function getActorMovies() {
    ...
    fetch(`/getActorData/${actorId}`).then(function(response) {
        return response.json()
    }).then(function(data) {
        ...
        let actorBirthday = data.actorBirthday
        let actorBirthplace = data.actorBirthplace
